...
def get_features(type, input_file, output_file):
    ...
    gpt_3_api = 'http://0.0.0.0:6006/inference'
    gpt_2_api = 'http://0.0.0.0:6006/inference'
    gpt_neo_api = 'http://0.0.0.0:6006/inference'
    gpt_J_api = 'http://0.0.0.0:6006/inference'
    llama_api = 'http://0.0.0.0:6006/inference'
    wenzhong_api = 'http://0.0.0.0:6006/inference'
    sky_text_api = 'http://0.0.0.0:6006/inference'
    damo_api = 'http://0.0.0.0:6006/inference'
    chatglm_api = 'http://0.0.0.0:6006/inference'
    alpaca_api = 'http://0.0.0.0:6006/inference'
    dolly_api = 'http://0.0.0.0:6006/inference'
    moss_api = 'http://0.0.0.0:6006/inference'
    kimi_api = 'http://0.0.0.0:6006/inference'
    en_model_apis = [gpt_2_api, gpt_neo_api, gpt_J_api, llama_api,gpt_3_api,alpaca_api,dolly_api]
    cn_model_apis = [wenzhong_api, sky_text_api, damo_api, chatglm_api,gpt_3_api, moss_api,kimi_api]
