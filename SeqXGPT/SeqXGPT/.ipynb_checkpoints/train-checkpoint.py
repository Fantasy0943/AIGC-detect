...
#         print("-----------test---",mask.shape,true_labels_1d.shape,pred_labels_1d.shape)
#         true_labels_1d = true_labels_1d[:31][mask[:31]]
#         pred_labels_1d = pred_labels_1d[mask[:31]]
...
def parse_args():
    ...
    parser.add_argument('--data_path', type=str, default='/root/autodl-tmp/SeqXGPT/SeqXGPT/encoder_Data')
    parser.add_argument('--train_path', type=str, default='/root/autodl-tmp/SeqXGPT/SeqXGPT/train.jsonl')
    parser.add_argument('--test_path', type=str, default='/root/autodl-tmp/SeqXGPT/SeqXGPT/test_2.jsonl')
