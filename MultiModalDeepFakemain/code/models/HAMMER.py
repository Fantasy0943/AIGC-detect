...
class HAMMER(nn.Module):
    def __init__(self, 
        ...
        self.text_encoder = BertForTokenClassification.from_pretrained('./bertbaseuncased',
                                                                    config=bert_config, 
        ...
        self.text_encoder_m = BertForTokenClassification.from_pretrained('./bertbaseuncased',
                                                                    config=bert_config,
                                                                    label_smoothing=config['label_smoothing'])       
